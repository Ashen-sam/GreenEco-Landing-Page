        ...
        <div className="bg-[#f7f6f2] w-full py-16  px-6 md:px-20 plus_jakarta_font">
            <div className="max-w-[1400px] m-auto">
                ...
                <div className="flex flex-col gap-12 bodini_font py-8">
                    ...
                    <div className="flex flex-col items-center text-center gap-4 border-b border-black/10 pb-10">
                        <div className="text-3xl md:text-5xl text-[#121C2D]">Our Mission to Plant Trees and Reduce</div>
                    </div>
                    <div className="flex flex-col md:flex-row items-center m-auto gap-6 md:gap-10">
                        <div className="flex items-center text-3xl md:text-5xl text-[#121C2D] gap-3">
                            <div className="h-10 w-10 rounded-full bg-black/10 flex items-center justify-center text-xl"><Shuffle size={16} /></div>
                            Carbon Footprint
                        </div>
