...
export const LatestNews = () => {
    ...
    return (
        <div className="bg-[#F7F5F2] border-2 border-zinc-300">
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row gap-12 items-start">

                    <div className=" shrink-0 lg:border-r-2  border-zinc-300">
                        <div className="pt-10">
                    ...
                    <div className="flex-1 ">
                        ...
                        <div className="relative h-1.5 w-full bg-gray-200 rounded-full mt-14 overflow-hidden">
